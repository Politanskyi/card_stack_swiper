...
typedef CardStackSwiperBuilder = Widget? Function(
...
typedef CardStackSwiperDirectionChange = void Function(
  CardStackSwiperDirection horizontal,
  CardStackSwiperDirection vertical,
);
...
typedef CardStackSwiperOnSwipe = FutureOr<bool> Function(
  int previousIndex,
  int? currentIndex,
...
typedef CardStackSwiperOnUndo = bool Function(
  int? previousIndex,
  int currentIndex,
  CardStackSwiperDirection direction,
);
